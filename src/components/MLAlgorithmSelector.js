...
const MLAlgorithmSelector = () => {
    ...
    const algorithms = {
        ...
        linearRegression: {
            ...
            algorithms: ['Ordinary Least Squares (OLS)', 'Ridge Regression (L2)', 'Lasso Regression (L1)', 'Elastic Net', 'Bayesian Linear Regression'],
        ...
        nonlinearSmall: {
            ...
            algorithms: ['Polynomial Regression', 'Support Vector Regression (SVR)', 'Kernel Ridge Regression', 'Gaussian Process Regression', 'K-Nearest Neighbors Regression'],
            ...
            details: 'Polynomial features create x², x³ terms. SVR uses RBF or polynomial kernels. GPs model functions as distributions. KNN uses distance metrics.'
        },
